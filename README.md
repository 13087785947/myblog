...
<br>
#### 背景：
&nbsp;&nbsp;&nbsp;&nbsp;博主是一名大四信息与计算科学专业的学生。坚持学习课堂上的java以及javaweb相关的知识，乃至学习Spring一系列的框架的过程尤为枯燥。每天看视频学习编程，“copy”视频中的代码运行让我就像是机器一样日复一日地重复着那些操作。而使得我能够坚持下去的兴趣，就是能够在不久的将来完成我自己的项目。也就有了我的个人博客网站。

#### 网站一览：
##### 首页
(MyBlogWebSite/picture/首页截图.png)

<br>
##### 分类页面

(MyBlogWebSite/picture/分类页面.jpg)

<br>

##### 归档页面

(MyBlogWebSite/picture/归档页面.jpg)

<br>

##### 后台管理页面

(MyBlogWebSite/picture/后台页面.png)

<br>

##### 后台发布文章页面

(MyBlogWebSite/picture/编写文章.jpg)

<br>

##### 应用分层页面![]####
(MyBlogWebSite/picture/应用分层.png)

<br>

##### 需求分析页面页面

(MyBlogWebSite/picture/需求分析.png)
...
- 在此感谢我的前端大佬好朋友曾中杰同学的支持，帮助我解决了很多前端的问题。
...
> 
秉承开源原则，该项目完整代码均能在我的github上面下载得到。希望这个项目能够帮到有需要的朋友那是再好不过。
https://github.com/13087785947/Nonggoing